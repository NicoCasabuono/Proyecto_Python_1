...
for i in range(20):
    if jugador1.pos() >= (120,200):
        print("La Tortuga violeta ha ganado")
        break
    elif jugador2.pos() >= (120,-200):
        print("La Tortuga azul ha ganado")   
        break 
    else:
        turno1 = input("Presiona el enter para avanzar la tortuga violeta.")
        turno1 = random.choice(dado)
        print("Tu numero es: ",turno1,"\nAvanzas: ",turno1*20)
        jugador1.pendown()
        jugador1.forward(20*turno1)

        turno2 = input("Presiona el enter para avanzar la tortuga azul")
